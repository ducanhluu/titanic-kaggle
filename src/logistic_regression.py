...
X_train, Y_train, X_dev, Y_dev, X_test, Y_test = divide_dataset(10, train_set_x_orig, train_set_y)
#- Logistic regression
...
layers_dims = [X_train.shape[0], 5, 5, 5, 5, Y_train.shape[0]]
parameters = L_layers_model(X_train, Y_train, layers_dims, num_epochs = 25000, learning_rate = 1, print_cost = True)
